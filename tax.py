...
app =FastAPI()
@app.get('/tax')
def tax(income:int=50000, disabilities:int=0,coupple:str="NH",parents:str="H",chile:int=1,agepF:int=60,agepM:int=55,income_pF:int=200,income_pM:int=200,income_c:int=0):
